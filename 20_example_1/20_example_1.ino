...
int raw, x, ema; // Voltage values from the IR sensor (0 ~ 1023)
...
void loop()
{
  ...
  x = ir_sensor_filtered(10, 0.5); // Replace n with your desired value
  Serial.print("FLT:"); Serial.println(x);
//  Serial.print("mm:"); Serial.println((0.0015*pow(x,2))+(-1.83*x)+541);
  Serial.print("mm:"); Serial.println((-0.00000231*pow(x,3))+(0.00457*pow(x,2))+(-3.08*x)+706);
}
